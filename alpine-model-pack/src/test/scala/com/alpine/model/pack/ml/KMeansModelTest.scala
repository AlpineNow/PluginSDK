...
class KMeansModelTest extends FunSuite {
  ...
  test("Should generate the correct SQL Expression") {
    ...
    val expectedClusteringSQL = ClusteringModelSQLExpressions(
      ...
      List(
        List(
          (ColumnarSQLExpression( """POWER((77.16666666666667 - "humidity") * (77.16666666666667 - "humidity") + (79.66666666666667 - "temperature") * (79.66666666666667 - "temperature"), 0.5)"""), ColumnName("DIST_0")),
          (ColumnarSQLExpression( """POWER((68.25 - "humidity") * (68.25 - "humidity") + (68.75 - "temperature") * (68.75 - "temperature"), 0.5)"""), ColumnName("DIST_1")),
          (ColumnarSQLExpression( """POWER((73.5 - "humidity") * (73.5 - "humidity") + (92.75 - "temperature") * (92.75 - "temperature"), 0.5)"""), ColumnName("DIST_2"))
        )
      )
    )
  ...
  test("Should generate the correct table generation SQL") {
    ...
    val expectedSQL =
      s"""
         ...
         | FROM
         | (SELECT
         | POWER((77.16666666666667 - "humidity") * (77.16666666666667 - "humidity") + (79.66666666666667 - "temperature") * (79.66666666666667 - "temperature"), 0.5)
         | AS "DIST_0",
         | POWER((68.25 - "humidity") * (68.25 - "humidity") + (68.75 - "temperature") * (68.75 - "temperature"), 0.5)
         | AS "DIST_1",
         | POWER((73.5 - "humidity") * (73.5 - "humidity") + (92.75 - "temperature") * (92.75 - "temperature"), 0.5)
         | AS "DIST_2"
         | FROM "demo"."golfnew"
