...
trait TableOutputParameterUtils extends OutputParameterUtils {
  ...
  /**
    ...
    */
  val defaultTableName: String = "alp@user_id_@flow_id_" + operatorNameUUIDVariable
  val resultTableNameParameterID: String = "resultTableName"
  val defaultDatabaseName: String = "@default_schema"
  val outputSchemaParameterId: String = "outputSchema"
  val viewOrTableParameterKey: String = "viewOrTable"
  val viewKey: String = "VIEW"
  val tableKey: String = "TABLE"
